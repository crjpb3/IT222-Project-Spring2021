...
<body>
    ...
    <div class="productDiv">
        ...
        <div style="width:45%">
            ...
            <p class="text">This is a vintage cowboy hat from the early 60s. It is made of leather with brass hardware and a braided leather strap. This hat is a truely unique find!</p>
        </div>
