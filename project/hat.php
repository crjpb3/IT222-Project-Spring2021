...
<body>
    ...
    <div class="productDiv">
        <a href="Clothing.php?dept=CLTH"><p class="back"><symbol>&#60</symbol>BACK</p></a>
        ...
        <table class="ptable">
            <tr>
                ...
                <td class="bid">
                    ...
                    <br />
                    <a class="btn btn-primary" href="BidForm.php?id=6" onclick="dateFunction()" id="button" target="blank">BID NOW!</a>
                    <br /><br />
