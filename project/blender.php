...
<body>
    ...
    <div class="productDiv">
        ...
        <table class="ptable">
            <tr>
                <td><img src="images/blender.jpg" class="bigProduct" /></td>
                <td class="bid">
        ...
        <div style="width:45%">
            ...
            <p class="text">This blender is one of the best on the market. It has superior blending power and advanced features.
            You can easily make smoothies and other great meals twice as fast as other blenders.</p>
        </div>
