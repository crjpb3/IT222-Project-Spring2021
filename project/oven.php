...
<body>
    ...
    <div class="productDiv">
        <a href="Appliances.php"><p class="back"><symbol>&#60</symbol>BACK</p></a>

        <h3>Electric Oven</h3>
        <table class="ptable">
            <tr>
                <td><img src="images/oven.jpg" class="bigProduct" /></td>
                <td class="bid">
        ...
        <div style="width:45%">
            ...
            <p class="text">This is a stainless steel electric oven. It features a 4-burner cooktop, a built-in air fryer, convection cooking, and a heating drawer. 
            It also features useful technology like a built-in timer and a oven light.</p>
        </div>
