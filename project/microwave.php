...
<body>
    ...
    <div class="productDiv">
        ...
        <table class="ptable">
            <tr>
                <td><img src="images/microwave.jpg" class="bigProduct" /></td>
                <td class="bid">
        ...
        <div style="width:45%">
            ...
            <p class="text">This 1000 watt microwave has all the features of a modern microwave. It has a unique sleek design. 
            It is easy to operate and has many time saving features to simplify your meal prep. </p>
        </div>
