...
<body>
    ...
    <div class="productDiv">
        <a href="Appliances.php?dept=APPL"><p class="back"><symbol>&#60</symbol>BACK</p></a>
        ...
        <table class="ptable">
            <tr>
                ...
                <td class="bid">
                    ...
                    <br />
                    <a class="btn btn-primary" href="BidForm.php?id=11" onclick="dateFunction()" id="button" target="blank">BID NOW!</a>
                    <br /><br />
