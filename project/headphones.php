...
<body>
    ...
    <div class="productDiv">
        ...
        <table class="ptable">
            <tr>
                <td><img src="images/headphones.jpg" class="bigProduct" /></td>
                <td class="bid">
        ...
        <div style="width:45%">
            ...
            <p class="text">This pair of headphones features high quality sound with excellent clarity and deep bass. 
            They have very durable ear cushioning and are adjustable for maximum comfort.
            </p>
        </div>
